...
인터뷰 질문들은 총 10가지를 받았고, 그 내용들이 모두 내가 참고했던 인터뷰 내용들과 상당히 유사하다는 점. 다른 인턴 과제들과 차이점은, 적어도 한 머신러닝 tool을 외부 library없이, 직접 파이썬으로 구현을 해야한다는 한다는 의무사항이 있었다.K-means는 너무 자주 사용하다 보니깐, 
